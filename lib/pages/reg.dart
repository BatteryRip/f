      ...
      body: Center(
          child: Column(
              ...
              children: <Widget>[
                ...
                _buildTextField(_usernameController, "Имя", "Логин", false),
                SizedBox(height: 8),
                _buildTextField(_emailController, "E-Mail", "Электронная почта", false),
                SizedBox(height: 8),
                _buildTextField(TextEditingController(), "Номер телефона", "Телефон", false),
                SizedBox(height: 8),
                _buildTextField(_passwordController, "Введите пароль", "Пароль", true),
                SizedBox(height: 8),
                _buildTextField(_confirmPasswordController, "Введите пароль", "Пароль", true),
                SizedBox(height: 8),
                ElevatedButton(
                  onPressed: () {
